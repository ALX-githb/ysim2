...
public class CombatMinigameScript : MonoBehaviour
{
	...
	private void Update()
	{
		if (Zoom)
		{
			...
			if (Timer > 1.5f)
			{
				Delinquent.CharacterAnimation.CrossFade("Delinquent_CombatA");
		...
		if (Path == 1)
		{
			...
			else if (Phase == 2)
			{
				...
				{
					Delinquent.CharacterAnimation["Delinquent_CombatB"].time = Delinquent.CharacterAnimation["Delinquent_CombatA"].time;
					Yandere.CharacterAnimation["Yandere_CombatB"].time = Yandere.CharacterAnimation["Yandere_CombatA"].time;
					Delinquent.CharacterAnimation.Play("Delinquent_CombatB");
			...
			else
			{
				...
				else if (Strike < 2 && Yandere.CharacterAnimation["Yandere_CombatA"].time > 2.5f)
				{
					...
					if (Yandere.Health < 1)
					{
						...
						{
							Delinquent.CharacterAnimation["Delinquent_CombatF"].time = Delinquent.CharacterAnimation["Delinquent_CombatA"].time;
							Yandere.CharacterAnimation["Yandere_CombatF"].time = Yandere.CharacterAnimation["Yandere_CombatA"].time;
							Delinquent.CharacterAnimation.CrossFade("Delinquent_CombatF");
						...
						{
							Delinquent.CharacterAnimation["Delinquent_CombatE"].time = Delinquent.CharacterAnimation["Delinquent_CombatA"].time;
							Yandere.CharacterAnimation["Yandere_CombatE"].time = Yandere.CharacterAnimation["Yandere_CombatA"].time;
							Delinquent.CharacterAnimation.CrossFade("Delinquent_CombatE");
				...
				{
					Delinquent.CharacterAnimation["Delinquent_CombatA"].time = 0f;
		...
		else if (Path == 2)
		{
			...
			else if (Phase == 4)
			{
				...
				{
					Delinquent.CharacterAnimation["Delinquent_CombatC"].time = Delinquent.CharacterAnimation["Delinquent_CombatB"].time;
					Yandere.CharacterAnimation["Yandere_CombatC"].time = Yandere.CharacterAnimation["Yandere_CombatB"].time;
					Delinquent.CharacterAnimation.Play("Delinquent_CombatC");
		...
		else if (Path == 3)
		{
			...
			else if (Phase == 6)
			{
				...
				{
					Delinquent.CharacterAnimation["Delinquent_CombatD"].time = Delinquent.CharacterAnimation["Delinquent_CombatC"].time;
					Yandere.CharacterAnimation["Yandere_CombatD"].time = Yandere.CharacterAnimation["Yandere_CombatC"].time;
					Delinquent.CharacterAnimation.Play("Delinquent_CombatD");
		...
		else if (Path == 6)
		{
			if (Phase == 4)
			{
				...
				if (Delinquent.CharacterAnimation["Delinquent_CombatF"].time > 7.83333f)
				{
	...
	private void Slowdown()
	{
		...
		MyVocals.pitch = SlowdownFactor;
		MyAudio.pitch = SlowdownFactor;
	}
