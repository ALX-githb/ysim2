...
public class CreditsScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else
		{
			...
			if (ControlFreak2.CF2Input.GetButtonDown("B") || !component.isPlaying)
			{
				FadeOut = true;
			}
		}
		...
		bool keyDown = ControlFreak2.CF2Input.GetKeyDown(KeyCode.Minus);
		bool keyDown2 = ControlFreak2.CF2Input.GetKeyDown(KeyCode.Equals);
		if (keyDown)
		{
			Time.timeScale -= 1f;
		}
