...
public class StudentInfoScript : MonoBehaviour
{
	...
	private void Update()
	{
		if (ControlFreak2.CF2Input.GetButtonDown("A"))
		{
			...
			{
				if (StudentManager.Students[CurrentStudent].Routine && !StudentManager.Students[CurrentStudent].InEvent && !StudentManager.Students[CurrentStudent].TargetedForDistraction && StudentManager.Students[CurrentStudent].ClubActivityPhase < 16)
				{
		...
		if (ControlFreak2.CF2Input.GetButtonDown("Y") && PromptBar.Button[3].enabled)
		{
