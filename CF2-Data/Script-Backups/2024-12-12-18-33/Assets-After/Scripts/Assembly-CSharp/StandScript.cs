...
public class StandScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			if (Weapons == 8 && Yandere.transform.position.y > 11.9f && ControlFreak2.CF2Input.GetButtonDown("RB") && !MissionModeGlobals.MissionMode && !Yandere.Laughing && Yandere.CanMove)
			{
				Yandere.Jojo();
			}
			return;
