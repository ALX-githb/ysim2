...
public class PhotoGalleryScript : MonoBehaviour
{
	...
	private void UpdatePhotoSelection()
	{
		...
		if (!NamingBully && ControlFreak2.CF2Input.GetButtonDown("B"))
		{
		...
		else if (CanAdjust && ControlFreak2.CF2Input.GetButtonDown("Y"))
		{
	...
	private void UpdatePhotoViewing()
	{
		...
		if (Corkboard && ControlFreak2.CF2Input.GetButtonDown("A"))
		{
	...
	private void UpdateCorkboardPhoto()
	{
		...
		if (ControlFreak2.CF2Input.GetButton("Y"))
		{
		...
		if (ControlFreak2.CF2Input.GetButton("X"))
		{
			MovingPhotograph.transform.localScale -= new Vector3(Time.deltaTime, Time.deltaTime, Time.deltaTime);
		...
		Vector2 vector2 = new Vector2(ControlFreak2.CF2Input.GetAxis("Horizontal") * 86.66666f * SpeedLimit, ControlFreak2.CF2Input.GetAxis("Vertical") * 86.66666f * SpeedLimit);
	...
	{
		MouseDelta.x += ControlFreak2.CF2Input.GetAxis("Horizontal") * 8.66666f * SpeedLimit;
		MouseDelta.y += ControlFreak2.CF2Input.GetAxis("Vertical") * 8.66666f * SpeedLimit;
	...
	private void UpdateCorkboardCursor()
	{
		...
		Vector2 vector2 = new Vector2(MouseDelta.x * 8.66666f + ControlFreak2.CF2Input.GetAxis("Horizontal") * 86.66666f * SpeedLimit, MouseDelta.y * 8.66666f + ControlFreak2.CF2Input.GetAxis("Vertical") * 86.66666f * SpeedLimit);
		...
		if (ControlFreak2.CF2Input.GetButtonDown("A") && Cursor.Photograph != null)
		{
			Cursor.Highlight.transform.position = new Vector3(Cursor.Highlight.transform.position.x, 100f, Cursor.Highlight.transform.position.z);
	...
	private void Update()
	{
		...
		else
		{
			...
			MouseDelta = new Vector2(ControlFreak2.CF2Input.mousePosition.x - PreviousPosition.x, ControlFreak2.CF2Input.mousePosition.y - PreviousPosition.y);
		...
		PreviousPosition = new Vector2(ControlFreak2.CF2Input.mousePosition.x, ControlFreak2.CF2Input.mousePosition.y);
	}
