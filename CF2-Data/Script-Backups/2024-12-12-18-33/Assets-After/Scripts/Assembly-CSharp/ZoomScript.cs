...
public class ZoomScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (!Yandere.Aiming)
		{
			TargetZoom += ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel");
		}
		if (Yandere.SithLord)
		{
			Slender = Mathf.Lerp(Slender, 2.5f, Time.deltaTime);
		}
		else if (Yandere.Slender || Yandere.Stand.Stand.activeInHierarchy || Yandere.Blasting || Yandere.PK || TallHat.activeInHierarchy)
		{
