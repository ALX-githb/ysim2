...
public class PauseScreenScript : MonoBehaviour
{
	...
	private void Start()
	{
		...
		{
			UISprite uISprite3 = PhoneIcons[10];
	...
	private void Update()
	{
		...
		if (!Show)
		{
			...
			if (!ControlFreak2.CF2Input.GetButtonDown("Start"))
			{
				return;
			}
			if (!Home)
		...
		{
			if (InputManager.TappedUp || ControlFreak2.CF2Input.GetKeyDown(KeyCode.W) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.UpArrow))
			{
				Row--;
				UpdateSelection();
			}
			if (InputManager.TappedDown || ControlFreak2.CF2Input.GetKeyDown(KeyCode.S) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.DownArrow))
			{
				Row++;
				UpdateSelection();
			}
			if (InputManager.TappedRight || ControlFreak2.CF2Input.GetKeyDown(KeyCode.D) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.RightArrow))
			{
				Column++;
				UpdateSelection();
			}
			if (InputManager.TappedLeft || ControlFreak2.CF2Input.GetKeyDown(KeyCode.A) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.LeftArrow))
			{
				Column--;
				UpdateSelection();
			}
			...
			if (!PressedB && (ControlFreak2.CF2Input.GetButtonDown("Start") || ControlFreak2.CF2Input.GetButtonDown("B")))
			{
				ExitPhone();
			}
			if (ControlFreak2.CF2Input.GetButtonUp("B"))
			{
				PressedB = false;
			}
		}
		...
		if (ControlFreak2.CF2Input.GetButtonUp("A"))
		{
			PressedA = false;
		}
	}
