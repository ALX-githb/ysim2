...
public class LowRepGameOverScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (Phase == 0)
		{
			...
			if (Yandere.CharacterAnimation["f02_LowRepGO_A"].time >= Yandere.CharacterAnimation["f02_LowRepGO_A"].length || ControlFreak2.CF2Input.GetButtonDown("A"))
			{
		...
		else if (Phase == 1)
		{
			...
			if (Timer > 2f || ControlFreak2.CF2Input.GetButtonDown("A"))
			{
		...
		{
			MyCamera.position += MyCamera.forward * Time.deltaTime * 0.1f;
			if (Yandere.CharacterAnimation["f02_LowRepGO_B"].time >= Yandere.CharacterAnimation["f02_LowRepGO_B"].length || ControlFreak2.CF2Input.GetButtonDown("A"))
			{
		...
		{
			MyCamera.position += MyCamera.forward * Time.deltaTime * 0.1f;
			if (Yandere.CharacterAnimation["f02_LowRepGO_C"].time >= Yandere.CharacterAnimation["f02_LowRepGO_C"].length || ControlFreak2.CF2Input.GetButtonDown("A"))
			{
		...
		{
			MyCamera.position += MyCamera.forward * Time.deltaTime * 0.1f;
			if (Yandere.CharacterAnimation["f02_LowRepGO_D"].time >= Yandere.CharacterAnimation["f02_LowRepGO_D"].length || ControlFreak2.CF2Input.GetButtonDown("A"))
			{
		...
		else if (Phase == 8)
		{
			MyCamera.position += MyCamera.forward * Time.deltaTime * 0.1f;
			Timer += Time.deltaTime;
			if (Timer > 2.5f || ControlFreak2.CF2Input.GetButtonDown("A"))
			{
