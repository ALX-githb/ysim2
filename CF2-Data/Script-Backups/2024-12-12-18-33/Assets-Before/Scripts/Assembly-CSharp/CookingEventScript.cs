...
public class CookingEventScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (!Clock.StopTime && EventCheck && Clock.HourTime > EventTime)
		{
			...
			if (EventStudent != null && !EventStudent.Distracted && !EventStudent.Meeting && !EventStudent.Wet)
			{
		...
		else
		{
			...
			if (!ConversationGlobals.GetTopicLearnedByStudent(1, 7) && Vector3.Distance(Yandere.transform.position, EventStudent.transform.position) < 5f)
			{
			...
			else if (EventPhase == 0)
			{
				...
				{
					EventStudent.Character.GetComponent<Animation>().Play("f02_prepareFood_00");
			...
			{
				EventStudent.Character.GetComponent<Animation>().Play("f02_prepareFood_00");
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time > 1f)
				{
					EventPhase++;
				}
			}
			else if (EventPhase == 2)
			{
				...
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time > 3f)
				{
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time > 5f)
				{
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time > 6f)
				{
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time > 7f)
				{
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time >= EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].length)
				{
					EventStudent.Character.GetComponent<Animation>().CrossFade("f02_cutFood_00");
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_cutFood_00"].time > 2.66666f)
				{
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_cutFood_00"].time > 3f)
				{
				...
				if (EventStudent.Character.GetComponent<Animation>()["f02_cutFood_00"].time > 6f)
				{
					Octodog.SetActive(false);
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_cutFood_00"].time >= EventStudent.Character.GetComponent<Animation>()["f02_cutFood_00"].length)
				{
					if (Loop < Octodogs.Length - 1)
					{
						...
						EventStudent.Character.GetComponent<Animation>()["f02_cutFood_00"].time = 0f;
						EventStudent.Character.GetComponent<Animation>().Play("f02_cutFood_00");
						Sausage.SetActive(true);
						EventPhase = 7;
						Rotation = -90f;
						Loop++;
					...
					{
						EventStudent.Character.GetComponent<Animation>().Play("f02_prepareFood_00");
						EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time = EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].length;
						EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].speed = -1f;
						EventPhase++;
					}
				}
			}
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time < EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].length - 1f)
				{
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time < EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].length - 2f)
				{
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time < EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].length - 3f)
				{
					JarLid.parent = Jar;
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time < EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].length - 5f)
				{
			...
			{
				if (EventStudent.Character.GetComponent<Animation>()["f02_prepareFood_00"].time <= 0f)
				{
					...
					EventStudent.Character.GetComponent<Animation>()[EventStudent.CarryAnim].weight = 1f;
					EventPhase++;
				}
			}
	...
	private void EndEvent()
	{
		if (!EventOver)
		{
			...
			EventStudent.Character.GetComponent<Animation>()[EventStudent.CarryAnim].weight = 0f;
			EventStudent.SmartPhone.SetActive(false);
			EventStudent.Pathfinding.speed = 1f;
