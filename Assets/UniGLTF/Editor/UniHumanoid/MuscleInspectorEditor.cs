...
// The migration is mechanical but touches every override; the non-generic API still works, so we
// suppress the warnings file-wide to keep behavior identical.
