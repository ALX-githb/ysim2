...
public class AmplifyMotionEffectBase : MonoBehaviour
{
	...
	{
		// SystemInfo.supportsImageEffects always returns true in modern Unity, so the check is a no-op.
		return true;
	}
	...
	{
		GameObject[] array = UnityEngine.Object.FindObjectsByType(typeof(GameObject), FindObjectsSortMode.None) as GameObject[];
