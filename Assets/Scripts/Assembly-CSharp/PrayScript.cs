...
public class PrayScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			if (StudentManager.Students[16] != null && !StudentManager.Students[16].Alive)
			{
				FemaleVictimChecked = true;
				Victims++;
			}
		}
		else if (StudentManager.Students[16] == null)
		{
		...
		{
			if (StudentManager.Students[15] != null && !StudentManager.Students[15].Alive)
			{
				MaleVictimChecked = true;
				Victims++;
			}
		}
		else if (StudentManager.Students[15] == null)
		{
		...
		if (GenderPrompt.Circle[0].fillAmount == 0f)
		{
			...
			if (!SpawnMale)
			{
				VictimLabel.color = new Color(VictimLabel.color.r, VictimLabel.color.g, VictimLabel.color.b, (!StudentGlobals.GetStudentDead(15)) ? 1f : 0.5f);
				GenderPrompt.Label[0].text = "     Male Victim";
				SpawnMale = true;
			}
			else
			{
				VictimLabel.color = new Color(VictimLabel.color.r, VictimLabel.color.g, VictimLabel.color.b, (!StudentGlobals.GetStudentDead(16)) ? 1f : 0.5f);
		...
		if (Prompt.Circle[0].fillAmount == 0f)
		{
			...
			if (!Yandere.Chased && Yandere.Chasers == 0)
			{
				...
				PromptBar.Show = true;
				StudentNumber = ((!SpawnMale) ? 16 : 17);
				if (StudentManager.Students[16] != null && !StudentManager.Students[16].gameObject.activeInHierarchy)
				{
					VictimLabel.color = new Color(VictimLabel.color.r, VictimLabel.color.g, VictimLabel.color.b, 0.5f);
				}
				if (StudentManager.Students[17] != null && !StudentManager.Students[17].gameObject.activeInHierarchy)
				{
					VictimLabel.color = new Color(VictimLabel.color.r, VictimLabel.color.g, VictimLabel.color.b, 0.5f);
				}
			}
