...
public class EventManagerScript : MonoBehaviour
{
	...
	private void Update()
	{
		if (!Clock.StopTime && EventCheck)
		{
			...
			{
				EventStudent[1] = StudentManager.Students[6];
			}
			...
			{
				EventStudent[2] = StudentManager.Students[7];
			}
			...
			if (Clock.HourTime > 13.01f && EventStudent[1] != null && EventStudent[2] != null && !EventStudent[1].Slave && !EventStudent[2].Slave && EventStudent[1].Pathfinding.canMove && EventStudent[2].Pathfinding.canMove)
			{
