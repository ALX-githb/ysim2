...
public class SecurityCameraScript : MonoBehaviour
{
	...
	private void OnTriggerStay(Collider other)
	{
		...
		{
			if ((!Yandere.Armed || !Yandere.EquippedWeapon.Suspicious) && (!(Yandere.Bloodiness > 0f) || Yandere.Paint) && !(Yandere.Sanity < 33.333f) && !Yandere.Attacking && !Yandere.Struggling && !Yandere.Dragging && !Yandere.Lewd && !Yandere.Dragging && !Yandere.Carrying && (!Yandere.Laughing || !(Yandere.LaughIntensity > 15f)))
			{
				return;
			}
