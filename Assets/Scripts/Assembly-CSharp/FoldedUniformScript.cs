...
public class FoldedUniformScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		InPosition = Yandere.transform.position.x > 43f && Yandere.transform.position.x < 51f && Yandere.transform.position.z > 2f && Yandere.transform.position.z < 14f;
		Prompt.HideButton[0] = !Yandere.CensorSteam[0].activeInHierarchy || Yandere.Bloodiness != 0f || !InPosition;
