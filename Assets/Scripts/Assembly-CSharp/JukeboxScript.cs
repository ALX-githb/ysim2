...
public class JukeboxScript : MonoBehaviour
{
	...
	private void Update()
	{
		if (!Yandere.PauseScreen.Show && !Yandere.EasterEggMenu.activeInHierarchy)
		{
			...
			if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.N) && Volume < 1f)
			{
				Volume += 0.1f;
			}
			if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.B) && Volume > 0f)
			{
				Volume -= 0.1f;
			}
		}
		...
		{
			if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.T) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha4))
			{
				Egg = true;
				KillVolume();
			...
			else if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.X) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.Z))
			{
				Egg = true;
				KillVolume();
			...
			else if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.E) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.M) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha1) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha2) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha7))
			{
				Egg = true;
				KillVolume();
				Ebola.enabled = true;
