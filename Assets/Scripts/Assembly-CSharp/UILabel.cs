...
public class UILabel : UIWidget
{
	...
	[SerializeField] Font mTrueTypeFont;
	[SerializeField] UnityEngine.Object mFont;
#if !UNITY_3_5
	[MultilineAttribute(6)]
#endif
	[SerializeField] string mText = "";
	[SerializeField] int mFontSize = 16;
	[SerializeField] FontStyle mFontStyle = FontStyle.Normal;
	[SerializeField] Alignment mAlignment = Alignment.Automatic;
	...
	[SerializeField] NGUIText.SymbolStyle mSymbols = NGUIText.SymbolStyle.Normal;
	[SerializeField] Vector2 mEffectDistance = Vector2.one;
	[SerializeField] Overflow mOverflow = Overflow.ShrinkContent;
	[SerializeField] bool mApplyGradient = false;
	[SerializeField] Color mGradientTop = Color.white;
	[SerializeField] Color mGradientBottom = new Color(0.7f, 0.7f, 0.7f);
	[SerializeField] int mSpacingX = 0;
	[SerializeField] int mSpacingY = 0;
	[SerializeField] bool mUseFloatSpacing = false;
	[SerializeField] float mFloatSpacingX = 0;
	[SerializeField] float mFloatSpacingY = 0;
	[SerializeField] bool mOverflowEllipsis = false;
	[SerializeField] int mOverflowWidth = 0;
	[SerializeField] int mOverflowHeight = 0;
	[SerializeField] Modifier mModifier = Modifier.None;
