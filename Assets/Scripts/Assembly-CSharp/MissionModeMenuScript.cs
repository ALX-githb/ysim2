...
public class MissionModeMenuScript : MonoBehaviour
{
	...
	private void Start()
	{
		...
		{
			CustomPopulationLabel.text = "High School Population: Off";
			PopulationLabel.text = "High School Population: Off";
		}
		else
		{
			CustomPopulationLabel.text = "High School Population: On";
			PopulationLabel.text = "High School Population: On";
		}
	}
	...
	private void Update()
	{
		...
		else if (Phase == 2)
		{
			...
			if (Selected == 1)
			{
				...
				PromptBar.Label[3].text = "Population";
		...
		else if (Phase == 3)
		{
			...
			else if (ControlFreak2.CF2Input.GetButtonDown("B"))
			{
			...
			else if (ControlFreak2.CF2Input.GetButtonDown("Y"))
			{
				UpdatePopulation();
			}
		}
		...
		else
		{
			...
			if (!ControlFreak2.CF2Input.anyKey)
			{
				...
				else if (MissionIDString[0] != '-')
				{
					GetNumbers();
					bool flag = false;
					if ((TargetNumber > 32 && TargetNumber < 41) || (TargetNumber > 45 && TargetNumber < 56) || TargetNumber > 97)
					{
						flag = true;
					}
					if (TargetNumber == 0)
					...
					else if (TargetNumber == 33)
					{
						ErrorLabel.text = "Invalid Mission ID (Target cannot be Osana...yet.)";
					}
					else if (TargetNumber == 34)
					{
						ErrorLabel.text = "Invalid Mission ID (Target cannot be Student #34...yet.)";
					}
					else if (PopulationNumber == 0 && flag)
					{
						ErrorLabel.text = "Invalid Mission ID (Population too low)";
					}
					...
					{
						ErrorLabel.text = "Invalid Mission ID (Final digit must be '0' or '1')";
					}
	...
	private void ChooseTarget()
	{
		if (Phase != 5)
		{
			...
			if ((TargetID > 32 && TargetID < 41) || (TargetID > 45 && TargetID < 56))
			{
				ChooseTarget();
			}
		}
		...
		{
			if (!OptionGlobals.HighPopulation && ((TargetID > 32 && TargetID < 41) || (TargetID > 45 && TargetID < 56)))
			{
				if (ControlFreak2.CF2Input.GetButtonDown("A"))
				{
					TargetID++;
		...
		if (TargetID == 33 || TargetID == 34 || TargetID == 35)
		{
			if (Phase == 5)
			{
				TargetID += (ControlFreak2.CF2Input.GetButtonDown("A") ? 1 : (-1));
			}
			ChooseTarget();
		}
	}
	...
	public void UpdateGraphics()
	{
		...
		if ((TargetNumber > 32 && TargetNumber < 41) || (TargetNumber > 45 && TargetNumber < 56))
		{
			TargetPortrait.mainTexture = BlankPortrait;
