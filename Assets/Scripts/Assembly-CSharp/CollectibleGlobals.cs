public static class CollectibleGlobals
{
	...
	{
		return GlobalsHelper.GetBool("HeadmasterTapeCollected_" + tapeID);
	}
	...
	{
		return GlobalsHelper.GetBool("HeadmasterTapeListened_" + tapeID);
	}
	...
	{
		return GlobalsHelper.GetBool("BasementTapeCollected_" + tapeID);
	}
	...
	{
		return GlobalsHelper.GetBool("BasementTapeListened_" + tapeID);
	}
	...
	{
		return GlobalsHelper.GetBool("MangaCollected_" + mangaID);
	}
	...
	{
		return GlobalsHelper.GetBool("TapeCollected_" + tapeID);
	}
	...
	{
		return GlobalsHelper.GetBool("TapeListened_" + tapeID);
	}
	...
	{
		Globals.DeleteCollection("BasementTapeCollected_", KeysOfBasementTapeCollected());
		Globals.DeleteCollection("BasementTapeListened_", KeysOfBasementTapeListened());
		Globals.DeleteCollection("MangaCollected_", KeysOfMangaCollected());
		Globals.DeleteCollection("TapeCollected_", KeysOfTapeCollected());
		Globals.DeleteCollection("TapeListened_", KeysOfTapeListened());
	}
}
