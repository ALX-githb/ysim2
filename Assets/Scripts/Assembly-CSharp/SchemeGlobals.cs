...
public static class SchemeGlobals
{
	...
	{
		return PlayerPrefs.GetInt("SchemePreviousStage_" + schemeID);
	}
	...
	{
		return PlayerPrefs.GetInt("SchemeStage_" + schemeID);
	}
	...
	{
		return GlobalsHelper.GetBool("SchemeStatus_" + schemeID);
	}
	...
	{
		return GlobalsHelper.GetBool("SchemeUnlocked_" + schemeID);
	}
	...
	{
		return GlobalsHelper.GetBool("ServicePurchased_" + serviceID);
	}
	...
	public static void DeleteAll()
	{
		...
		Globals.DeleteCollection("SchemePreviousStage_", KeysOfSchemePreviousStage());
		Globals.DeleteCollection("SchemeStage_", KeysOfSchemeStage());
		Globals.DeleteCollection("SchemeStatus_", KeysOfSchemeStatus());
		Globals.DeleteCollection("SchemeUnlocked_", KeysOfSchemeUnlocked());
		Globals.DeleteCollection("ServicePurchased_", KeysOfServicePurchased());
	}
}
