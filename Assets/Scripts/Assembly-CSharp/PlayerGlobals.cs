...
public static class PlayerGlobals
{
	...
	{
		return GlobalsHelper.GetBool("Photo_" + photoID);
	}
	...
	{
		return GlobalsHelper.GetBool("PhotoOnCorkboard_" + photoID);
	}
	...
	{
		return GlobalsHelper.GetVector2("PhotoPosition_" + photoID);
	}
	...
	{
		return PlayerPrefs.GetFloat("PhotoRotation_" + photoID);
	}
	...
	{
		return GlobalsHelper.GetBool("SenpaiPhoto_" + photoID);
	}
	...
	{
		return PlayerPrefs.GetInt("BullyPhoto_" + photoID);
	}

	public static void SetBullyPhoto(int photoID, int value)
	{
		PlayerPrefs.SetInt("BullyPhoto_" + photoID, value);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentFriend_" + studentID);
	}
	...
	public static void DeleteAll()
	{
		...
		Globals.DeleteCollection("Photo_", KeysOfPhoto());
		Globals.DeleteCollection("PhotoOnCorkboard_", KeysOfPhotoOnCorkboard());
		Globals.DeleteCollection("PhotoPosition_", KeysOfPhotoPosition());
		Globals.DeleteCollection("PhotoRotation_", KeysOfPhotoRotation());
		Globals.Delete("Reputation");
		Globals.Delete("Seduction");
		Globals.Delete("SeductionBonus");
		Globals.DeleteCollection("SenpaiPhoto_", KeysOfSenpaiPhoto());
		Globals.Delete("SenpaiShots");
		Globals.Delete("SocialBonus");
		Globals.Delete("SpeedBonus");
		Globals.Delete("StealthBonus");
		Globals.DeleteCollection("StudentFriend_", KeysOfStudentFriend());
		Globals.DeleteCollection("StudentPantyShot_", KeysOfStudentPantyShot());
	}
}
