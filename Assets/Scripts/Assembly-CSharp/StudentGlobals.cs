...
public static class StudentGlobals
{
	...
	{
		return PlayerPrefs.GetString("StudentAccessory_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentArrested_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentBroken_" + studentID);
	}
	...
	{
		return PlayerPrefs.GetFloat("StudentBustSize_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetColor("StudentColor_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentDead_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentDying_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentExpelled_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentExposed_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetColor("StudentEyeColor_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentGrudge_" + studentID);
	}
	...
	{
		return PlayerPrefs.GetString("StudentHairstyle_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentKidnapped_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentMissing_" + studentID);
	}
	...
	{
		return PlayerPrefs.GetString("StudentName_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentPhotographed_" + studentID);
	}
	...
	{
		return GlobalsHelper.GetBool("StudentReplaced_" + studentID);
	}
	...
	{
		return PlayerPrefs.GetInt("StudentReputation_" + studentID);
	}
	...
	{
		return PlayerPrefs.GetFloat("StudentSanity_" + studentID);
	}
	...
	public static void DeleteAll()
	{
		...
		Globals.DeleteCollection("StudentAccessory_", KeysOfStudentAccessory());
		Globals.DeleteCollection("StudentArrested_", KeysOfStudentArrested());
		Globals.DeleteCollection("StudentBroken_", KeysOfStudentBroken());
		Globals.DeleteCollection("StudentBustSize_", KeysOfStudentBustSize());
		GlobalsHelper.DeleteColorCollection("StudentColor_", KeysOfStudentColor());
		Globals.DeleteCollection("StudentDead_", KeysOfStudentDead());
		Globals.DeleteCollection("StudentDying_", KeysOfStudentDying());
		Globals.DeleteCollection("StudentExpelled_", KeysOfStudentExpelled());
		Globals.DeleteCollection("StudentExposed_", KeysOfStudentExposed());
		GlobalsHelper.DeleteColorCollection("StudentEyeColor_", KeysOfStudentEyeColor());
		Globals.DeleteCollection("StudentGrudge_", KeysOfStudentGrudge());
		Globals.DeleteCollection("StudentHairstyle_", KeysOfStudentHairstyle());
		Globals.DeleteCollection("StudentKidnapped_", KeysOfStudentKidnapped());
		Globals.DeleteCollection("StudentMissing_", KeysOfStudentMissing());
		Globals.DeleteCollection("StudentName_", KeysOfStudentName());
		Globals.DeleteCollection("StudentPhotographed_", KeysOfStudentPhotographed());
		Globals.DeleteCollection("StudentReplaced_", KeysOfStudentReplaced());
		Globals.DeleteCollection("StudentReputation_", KeysOfStudentReputation());
		Globals.DeleteCollection("StudentSanity_", KeysOfStudentSanity());
		Globals.DeleteCollection("StudentSlave", KeysOfStudentSlave());
	}
}
