...
public class TranqCaseScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		Hinge.localEulerAngles = new Vector3(Hinge.localEulerAngles.x, Hinge.localEulerAngles.y, Mathf.Lerp(Hinge.localEulerAngles.z, (!Open) ? 0f : 135f, Time.deltaTime * 10f));
	}
}
