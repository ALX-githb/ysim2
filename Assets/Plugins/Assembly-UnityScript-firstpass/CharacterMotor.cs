...
public class CharacterMotor : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024SubtractNewPlatformVelocity_002417 : GenericGenerator<object>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<object>, IEnumerator
		{
			internal Transform _0024platform_002418;

			internal CharacterMotor _0024self__002419;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (_0024self__002419.movingPlatform.enabled && (_0024self__002419.movingPlatform.movementTransfer == MovementTransferOnJump.InitTransfer || _0024self__002419.movingPlatform.movementTransfer == MovementTransferOnJump.PermaTransfer))
					{
						if (_0024self__002419.movingPlatform.newPlatform)
						{
							_0024platform_002418 = _0024self__002419.movingPlatform.activePlatform;
				...
				case 2:
					...
					break;
				case 3:
					if (_0024self__002419.grounded && _0024platform_002418 == _0024self__002419.movingPlatform.activePlatform)
					{
					...
					goto case 4;
				case 4:
					_0024self__002419.movement.velocity = _0024self__002419.movement.velocity - _0024self__002419.movingPlatform.platformVelocity;
					goto IL_0124;
				case 1:
					{
						result = 0;
		...
		internal CharacterMotor _0024self__002420;

		public _0024SubtractNewPlatformVelocity_002417(CharacterMotor self_)
		{
		...
		{
			return new _0024(_0024self__002420);
		}
	}
	...
	{
		return new _0024SubtractNewPlatformVelocity_002417(this).GetEnumerator();
	}
